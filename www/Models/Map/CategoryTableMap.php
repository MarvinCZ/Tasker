...
class CategoryTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'UserId', 'Name', 'Color', ),
        self::TYPE_CAMELNAME     => array('id', 'userId', 'name', 'color', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID, CategoryTableMap::COL_USER_ID, CategoryTableMap::COL_NAME, CategoryTableMap::COL_COLOR, ),
        self::TYPE_FIELDNAME     => array('id', 'user_id', 'name', 'color', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'UserId' => 1, 'Name' => 2, 'Color' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'userId' => 1, 'name' => 2, 'color' => 3, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID => 0, CategoryTableMap::COL_USER_ID => 1, CategoryTableMap::COL_NAME => 2, CategoryTableMap::COL_COLOR => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'user_id' => 1, 'name' => 2, 'color' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
